...
exports.determineBucketSize = determineBucketSize;
exports.generateBuckets = generateBuckets;
exports.formatBucketLabel = formatBucketLabel;
exports.getMySQLBucketFormat = getMySQLBucketFormat;
exports.roundToBucket = roundToBucket;
exports.parseTimeRanges = parseTimeRanges;
exports.isInTimeRange = isInTimeRange;
exports.parseDaysOfWeek = parseDaysOfWeek;
exports.isOnDayOfWeek = isOnDayOfWeek;
/**
 ...
 * @returns 'hour' or 'day'
 */
function determineBucketSize(from, to) {
 ...
 */
function generateBuckets(from, to, bucketSize) {
    const buckets = [];
 ...
 */
function getMySQLBucketFormat(bucketSize) {
    if (bucketSize === 'hour') {
 ...
 */
function roundToBucket(date, bucketSize) {
 ...
 */
function isInTimeRange(date, timeRanges) {
 ...
 */
function isOnDayOfWeek(date, daysOfWeek) {
...
//# sourceMappingURL=time-bucket.utils.js.map