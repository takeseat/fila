...
exports.isBrazilianPhone = isBrazilianPhone;
exports.validateInternationalPhone = validateInternationalPhone;
exports.validateBrazilianPhone = validateBrazilianPhone;
exports.normalizeLocalPhone = normalizeLocalPhone;
exports.buildFullPhone = buildFullPhone;
exports.validateBrazilianLocalPhone = validateBrazilianLocalPhone;
 ...
 */
function isBrazilianPhone(phone) {
 ...
 * @returns true if valid Brazilian format
 */
function validateBrazilianLocalPhone(phone) {
 ...
 */
function validateLocalPhone(phone, minLength = 6) {
    const normalized = normalizeLocalPhone(phone);
