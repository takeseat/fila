...
class ReportsService {
    async getWaitlistSummary(restaurantId, from, to) {
        ...
        const entries = await database_1.default.waitlistEntry.findMany({
            where,
        });
        ...
        const seatedEntries = entries.filter((e) => e.status === 'SEATED' && e.seatedAt && e.createdAt);
