...
type SettingsForm = {
    ...
    autoNotPickedUpMinutes: number | null;
};
...
export function ParametersTab() {
    ...
    useEffect(() => {
        if (settings) {
            ...
            setValue('autoNotPickedUpMinutes', settings.autoNotPickedUpMinutes ?? 30);
        }
    }, [settings, setValue]);
    ...
    const onSubmit = (data: SettingsForm) => {
        const formattedData = {
            ...
            autoNotPickedUpMinutes: data.autoNotPickedUpMinutes ? Number(data.autoNotPickedUpMinutes) : 30,
        };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        {errors.autoNotPickedUpMinutes && (
                            <p className="mt-1 text-xs text-danger-500">{t('pickupParameters.autoNotPickedUp.validation')}</p>
                        )}
                    </div>
                </div>
            </div>
