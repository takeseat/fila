...
import { Button, Input, Badge, EmptyState, Progress, Spinner } from '../components/ui';
                            ...
                            {filteredActiveEntries.map((entry: any, index: number) => {
                                ...
                                return (
                                    <div
                                        key={entry.id}
                                        className={`
                                        bg-bg-surface border border-border-default rounded-card shadow-card p-6 hover:shadow-xl transition-all duration-200 relative overflow-hidden
                                        ${cardBorderClass}
                                    `}
                                    >
                                        {badgeContent}
